...
2. 스레드
    ...
    ![Untitled](lkc-os/2 주 차/Untitled.png)
    ...
    **PCB가 필요한 이유?**
    ...
    ![Untitled](lkc-os/2 주 차/Untitled%201.png)
 ...
 ![Untitled](lkc-os/2 주 차/Untitled.png)
    ...
    ![sharedmemo](lkc-os/2 주 차/sharedmemo.png)
    ...
    ![pipe.PNG](lkc-os/2 주 차/pipe.png)
    ...
    ![socket.PNG](lkc-os/2 주 차/socket.png)
    
    ![sck1.PNG](lkc-os/2 주 차/sck1.png)
    
    ![msgQ.PNG](lkc-os/2 주 차/msgQ.png)
    
    ![memMap.PNG](lkc-os/2 주 차/memMap.png)
    
    ![RPC.PNG](lkc-os/2 주 차/RPC.png)
    
    ![summary.PNG](lkc-os/2 주 차/summary.png)
